...
const char* instructionsData[MAX_Y] = {
    ...
    "|     LEFT          A        J      |   *    Obstacle  Can be pushed          |", // 10
...
inline Screen* getLayoutById(int id) {
    switch (id) {
        case -2: return &mainMenuScreen;
        case -1: return &instructionsScreen;
        case -3: return &pauseScreen;
        case -4: return &victoryScreen;
        case -5: return &gameOverScreen;
        case 0:  return &room0Layout;
        case 1:  return &room1Layout;
        case 2:  return &room2Layout;
        default: return &room0Layout;
    }
}
