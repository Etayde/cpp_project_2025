...
void Game::initializeRooms()
{
    ...
    rooms[0].addSpring({Point(51, 1), Point(51, 2), Point(51, 3), Point(51, 4)}, 4);
    rooms[0].addSpring({Point(1, 10), Point(2, 10), Point(3, 10)}, 3);
    rooms[0].addSpring({Point(63, 18), Point(63, 19)}, 2);
